...
class DataProvider(Protocol):
    ...
    def search_packages(
        self, criteria: SearchCriteria, limit: Optional[int] = None
    ) -> List[TravelPackage]:
        """Buscar paquetes según criterios."""
        ...

    def get_package_details(self, package_id: str) -> Optional[TravelPackage]:
        """Obtener detalles de un paquete específico."""
        ...

    def get_price_history(self, package_id: str) -> List[Dict[str, Any]]:
...
class AnalysisEngine(Protocol):
    ...
    def analyze_package(
        self, package: TravelPackage, context: Dict[str, Any]
    ) -> AnalysisResult:
        """Analizar un paquete turístico."""
        ...

    def compare_packages(self, packages: List[TravelPackage]) -> Dict[str, Any]:
        """Comparar múltiples paquetes."""
        ...

    def get_insights(self, data: Dict[str, Any]) -> List[str]:
...
class RecommendationEngine(Protocol):
    ...
    def rank_packages(
        self, packages: List[TravelPackage], context: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
...
class MetricsCollector(Protocol):
    ...
    def record(
        self, metric: str, value: Any, tags: Optional[Dict[str, str]] = None
    ) -> None:
        """Registrar métrica."""
        ...
...
class AgentComponent(ABC):
    ...
    def record_metric(
        ...
        self.logger.debug(f"Recording metric: {metric}", value=value, tags=tags)
...
class AgentInterface(Protocol):
    ...
    async def process_query(self, query: SalesQuery) -> Dict[str, Any]:
        """Procesar consulta de venta."""
        ...

    async def get_recommendations(
        self, customer: CustomerProfile, criteria: SearchCriteria
    ) -> List[TravelPackage]:
        """Obtener recomendaciones."""
        ...

    async def analyze_package(self, package_id: str) -> AnalysisResult:
        """Analizar paquete específico."""
        ...

    async def track_interaction(
        self, customer_id: str, interaction_type: str, data: Dict[str, Any]
    ) -> None:
