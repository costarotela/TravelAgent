...
from .auth import get_current_user, create_access_token, verify_password, ACCESS_TOKEN_EXPIRE_MINUTES
...
async def login_for_access_token(form_data: OAuth2PasswordRequestForm = Depends()):
    ...
    if form_data.username != "test" or not verify_password(form_data.password, "$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewKyNiAYqeScNazS"):  # password: test
        raise HTTPException(
