...
class OLAMonitor:
    ...
    def __init__(self, port: int = 9090):
        ...
        self.paquetes_nuevos = Gauge(
            "ola_new_packages", "Cantidad de paquetes nuevos detectados", ["destino"]
        )
        ...
        self.precio_promedio = Gauge(
            "ola_average_price", "Precio promedio de paquetes", ["destino", "moneda"]
        )
        self.precio_minimo = Gauge(
            "ola_min_price", "Precio mínimo de paquetes", ["destino", "moneda"]
        )
        self.precio_maximo = Gauge(
            "ola_max_price", "Precio máximo de paquetes", ["destino", "moneda"]
        )
    ...
    def update_package_metrics(self, stats: Dict, destino: str):
        ...
        """
        self.paquetes_nuevos.labels(destino=destino).set(stats.get("total_nuevos", 0))
