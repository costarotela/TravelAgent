...
class ConfidenceCalibrator:
    ...
    async def calibrate_confidence(
        ...
        calibration_bins = self._analyze_historical_data(
            action_type,
            historical_data
        )
    ...
    def _analyze_historical_data(
        ...
        for i in range(self.num_bins):
            ...
            bin_actions = [
                action for action in relevant_data
    ...
    def _adjust_confidence(
        ...
        base_adjustment = (
            closest_bin.empirical_confidence - 
            closest_bin.predicted_confidence
        )
        ...
        adjustment = (
            base_adjustment * calibration_weight * 
            reliability_weight * market_confidence
        )
