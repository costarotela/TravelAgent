...
class OLAChangeDetector:
    ...
    def detect_changes(self, packages: List[PaqueteOLA]) -> Dict:
        ...
        updated_hashes = {
            h
            for h in potential_updates
            if self._has_relevant_changes(self.previous_state[h], new_state[h])
        }
    ...
    def _has_relevant_changes(self, prev_pkg: PaqueteOLA, curr_pkg: PaqueteOLA) -> bool:
        """
    ...
    def _analyze_price_changes(self, updated_packages: List[PaqueteOLA]) -> Dict:
        ...
        return {"total_cambios": len(price_changes), "cambios": price_changes}
    ...
    def _analyze_date_changes(self, updated_packages: List[PaqueteOLA]) -> Dict:
        ...
        return {"total_cambios": len(date_changes), "cambios": date_changes}
