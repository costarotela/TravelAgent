...
async def test_advanced_estimator():
    ...
    for origin, destination in routes:
        ...
        for action_type in ['purchase', 'sell', 'investigate']:
            ...
            print(f"   ✓ Confiabilidad: {estimation.calibration_metrics.reliability_score:.2%}")
            print(f"   ✓ Resolución: {estimation.calibration_metrics.resolution_score:.2%}")
    
    # Mostrar tabla de resultados
    print("\nResumen de Análisis:")
    headers = [
        "Ruta", "Acción", "Impacto", "Conf. Original", 
        "Conf. Calibrada", "Volatilidad", "Recomendación", "Riesgo"
    ]
