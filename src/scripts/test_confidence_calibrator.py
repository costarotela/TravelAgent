...
async def test_confidence_calibrator():
    ...
    market_conditions = {"volatility": 0.15, "trend": "stable", "demand": 0.7}
    ...
    for action_type in action_types:
        ...
        for confidence in confidence_levels:
            ...
            calibrated, metrics = await calibrator.calibrate_confidence(
                confidence, action_type, market_conditions, historical_data
            )
            ...
            calibrator.update_calibration(confidence, actual_outcome, action_type)
