...
async def test_learning():
    ...
    for origin, destination in routes:
        ...
        metrics = await learning_system.learn_from_execution((origin, destination), executions)
        ...
        print("\n2. Recomendaciones:")
        recommendations = await learning_system.get_route_recommendations(origin, destination)
