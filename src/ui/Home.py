...
def show_home():
    ...
    with st.sidebar:
        ...
        st.write(
            f"👋 Welcome, **{st.session_state.user['full_name'] or st.session_state.user['username']}**!"
        )
    ...
    activities = [
        {
            "date": "2025-02-15",
            "action": "New Booking",
            "details": "Paris, France - 7 days",
        },
        {
            "date": "2025-02-14",
            "action": "Payment Received",
            "details": "$2,500 - Booking #1234",
        },
        {
            "date": "2025-02-13",
            "action": "Itinerary Updated",
            "details": "Added museum tour to Tokyo trip",
        },
    ]
