...
class PackageAnalyzer:
        ...
        try:
            ...
            return PackageAnalysis(
                ...
                price_analysis={
                    ...
                    "historical_avg": sum(price_history)/len(price_history) if price_history else package.price,
    ...
    def _apply_criteria(
        ...
        for key, value in criteria.items():
            if key == "budget":
                ...
                if (
                    package.start_date >= value["start"] and
                    package.end_date <= value["end"]
                ):
                    score += 1
            elif key == "services":
                required = set(value)
    ...
    def _get_services_summary(self, package: TravelPackage) -> Dict[str, Any]:
        ...
        return {
            ...
            "premium_count": len([
                s for s in package.included_services
